        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorBirthDate = table.Column<DateOnly>(type: "date", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GenreRating = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublisherEmail = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PublisherPhoneNumber = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ISPN = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookReviewId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BookReviewerName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BookReviewTitle = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BorrowRequest", x => x.BorrowRequestId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_UserPhoneNumber",
                table: "AspNetUsers",
                column: "UserPhoneNumber",
                unique: true,
                filter: "[UserPhoneNumber] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BorrowRequest_BorrowedDate",
                table: "BorrowRequest",
                column: "BorrowedDate");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Publisher_PublisherEmail",
                table: "Publisher",
                column: "PublisherEmail",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Publisher_PublisherPhoneNumber",
                table: "Publisher",
                column: "PublisherPhoneNumber",
                unique: true);
        }
